...
ap.add_argument("-l", "--load", required=False, default="1", help="Load a trained neural network")
...
ap.add_argument("-i", "--iterations", required=False, default="400000", help="Number of interations of backpropagation")
